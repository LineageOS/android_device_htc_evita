...
# Audio
PRODUCT_COPY_FILES += \
    device/htc/evita/configs/audio_effects.conf:system/vendor/etc/audio_effects.conf \
    device/htc/evita/configs/audio_platform_info.xml:system/etc/audio_platform_info.xml \
    device/htc/evita/configs/audio_policy.conf:system/etc/audio_policy.conf \
    device/htc/evita/configs/mixer_paths.xml:system/etc/mixer_paths.xml
